  ...
  Future<Database> initDatabase() async {
    ...
    db = await openDatabase(
      ...
      onCreate: (Database db, int vision) async {
        await db.execute(
            "CREATE TABLE IF NOT EXISTS $tableName($colId INTEGER PRIMARY KEY AUTOINCREMENT,$colName TEXT,$colPrice REAL,$colQuantity INTEGER,$colDummyPrice REAL,$colImage BLOB);");
      },
    );
    return db;
  }
